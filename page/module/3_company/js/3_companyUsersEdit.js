if(document.querySelector('#companyUsersEdit')){
    const companyUsersEdit = {
        data() {
            return {
                firstName       : ''
                , lastName      : ''
    ...
    const companyUsersEditApp =  Vue.createApp(companyUsersEdit);
    companyUsersEditApp.component('Multiselect', VueformMultiselect);
    companyUsersEditApp.mount('#companyUsersEdit');
}
