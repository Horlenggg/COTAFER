...
const TABLE_PASSWORD = {
    ...
    <div class="relative w-full group">
        <input v-model="isData" class="w-full bg-transparent" :type="isShow ? 'text':'password'" disabled>
        <div class="absolute top-0 right-0">
            <svg v-if="!isShow" @click="onShow" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer hidden group-hover:block" viewBox="0 0 20 20" fill="currentColor">
                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
            </svg>
            <svg v-else @click="onShow" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer hidden group-hover:block" viewBox="0 0 20 20" fill="currentColor">
