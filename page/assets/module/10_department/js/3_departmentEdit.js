if(document.querySelector('#departmentEdit')){
    ...
    const departmentEditApp =  Vue.createApp(departmentEdit);
    departmentEditApp.component('collapse-vue', COLLAPSE_COMPONENT);
    departmentEditApp.mount('#departmentEdit');    
}
