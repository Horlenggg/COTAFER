if(document.querySelector('#testGonokaEdit')){
    const testGonokaEdit = {
        data() {
            return {
                version             : ''
    ...
    const testGonokaEditApp =  Vue.createApp(testGonokaEdit);
    testGonokaEditApp.component('Multiselect', VueformMultiselect);
    testGonokaEditApp.mount('#testGonokaEdit');    
}
