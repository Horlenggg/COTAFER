if(document.querySelector('#usersControlEdit')){
    const usersControlEdit = {
        data() {
            return {
                firstName       : ''
                , lastName      : ''
    ...
    const usersControlEditApp =  Vue.createApp(usersControlEdit);
    usersControlEditApp.component('Multiselect', VueformMultiselect);
    usersControlEditApp.mount('#usersControlEdit');
}
