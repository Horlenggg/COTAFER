if(document.querySelector('#usersControlAdd')){
    const usersControlAdd = {
        data() {
            return {
                firstName       : ''
                , lastName      : ''
    ...
    const usersControlAddApp =  Vue.createApp(usersControlAdd);
    usersControlAddApp.component('Multiselect', VueformMultiselect);
    usersControlAddApp.mount('#usersControlAdd');    
}
