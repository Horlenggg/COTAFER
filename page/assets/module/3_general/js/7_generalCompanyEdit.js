if(document.querySelector('#generalCompanyEdit')){
    const generalCompanyEdit = {
        data() {
            return {
                companyName     : ''
                , title         : ''
                ...
                if(this.companyName || this.title || this.website || this.email || this.phoneNumber || this.icon.length !== 0 ){
                    if(!this.isCnVal && !this.isTtVal && !this.isWsVal && !this.isEmVal && !this.isPhVal && !this.isIcVal){
                        let 
                            ...
                            form.append(cName, title, website, email, pNumber, icon);
    
                            form.method             = 'POST'
                            form.action             = '/general/company/add'
    ...
    const generalCompanyEditApp =  Vue.createApp(generalCompanyEdit);
    generalCompanyEditApp.mount('#generalCompanyEdit');    
}
