if(document.querySelector('#generalCompanyAdd')){
    const generalCompanyAdd = {
        data() {
            return {
                companyName     : ''
                , title         : ''
    ...
    const generalCompanyAddApp =  Vue.createApp(generalCompanyAdd);
    generalCompanyAddApp.mount('#generalCompanyAdd');    
}
