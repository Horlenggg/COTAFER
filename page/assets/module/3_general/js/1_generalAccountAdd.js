...
const generalAccountAddApp =  Vue.createApp(generalAccountAdd);
generalAccountAddApp.component('Multiselect', VueformMultiselect);
generalAccountAddApp.mount('#generalAccountAdd');