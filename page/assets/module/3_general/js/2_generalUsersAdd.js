if(document.querySelector('#generalUsersAdd')){
    const generalUsersAdd = {
        data() {
            return {
                firstName       : ''
                , lastName      : ''
    ...
    const generalUsersAddApp =  Vue.createApp(generalUsersAdd);
    generalUsersAddApp.component('Multiselect', VueformMultiselect);
    generalUsersAddApp.mount('#generalUsersAdd');    
}
