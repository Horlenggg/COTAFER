if(document.querySelector('#companyCompanyEdit')){
    const companyCompanyEdit = {
        data() {
            return {
                companyName     : ''
                , title         : ''
    ...
    const companyCompanyEditApp =  Vue.createApp(companyCompanyEdit);
    companyCompanyEditApp.mount('#companyCompanyEdit');    
}
