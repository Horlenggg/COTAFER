if(document.querySelector('#companyRolesAdd')){
    const companyRolesAdd = {
        data() {
            return {
                roleName                : ''
                , availableUsers        : []
    ...
    const companyRolesAddApp =  Vue.createApp(companyRolesAdd);
    companyRolesAddApp.component('Multiselect', VueformMultiselect);
    companyRolesAddApp.component('collapse-vue', COLLAPSE_COMPONENT);
    companyRolesAddApp.mount('#companyRolesAdd');    
}
