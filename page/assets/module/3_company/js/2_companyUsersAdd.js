if(document.querySelector('#companyUsersAdd')){
    ...
    const companyUsersAddApp =  Vue.createApp(companyUsersAdd);
    companyUsersAddApp.component('Multiselect', VueformMultiselect);
    companyUsersAddApp.mount('#companyUsersAdd');    
}
