if(document.querySelector('#companyDepartmentEdit')){
    const companyDepartmentEdit = {
        data() {
            return {
    ...
    const companyDepartmentEditApp =  Vue.createApp(companyDepartmentEdit);
    companyDepartmentEditApp.component('collapse-vue', COLLAPSE_COMPONENT);
    companyDepartmentEditApp.mount('#companyDepartmentEdit');    
}
